...
static const struct mtk_iommu_port mm_port_mt6855[] = {
	...
	MM_IOMMU_PORT_INIT("LARB1_PORT6", DISP_IOMMU, 0, 0x0, 6),
	MM_IOMMU_PORT_INIT("LARB1_PORT7", DISP_IOMMU, 0, 0x0, 7),
	MM_IOMMU_PORT_INIT("LARB1_PORT8", DISP_IOMMU, 0, 0x0, 8),
	MM_IOMMU_PORT_INIT("LARB1_PORT9", DISP_IOMMU, 0, 0x0, 9),
	MM_IOMMU_PORT_INIT("LARB1_PORT10", DISP_IOMMU, 0, 0x0, 10),
	MM_IOMMU_PORT_INIT("LARB1_PORT11", DISP_IOMMU, 0, 0x0, 11),
	MM_IOMMU_PORT_INIT("LARB1_PORT12", DISP_IOMMU, 0, 0x0, 12),
	MM_IOMMU_PORT_INIT("LARB1_PORT13", DISP_IOMMU, 0, 0x0, 13),
	MM_IOMMU_PORT_INIT("LARB1_PORT14", DISP_IOMMU, 0, 0x0, 14),
	...
	MM_IOMMU_PORT_INIT("LARB2_PORT6", DISP_IOMMU, 2, 0x14, 6),
	MM_IOMMU_PORT_INIT("LARB2_PORT7", DISP_IOMMU, 2, 0x14, 7),
	MM_IOMMU_PORT_INIT("LARB2_PORT8", DISP_IOMMU, 2, 0x14, 8),
