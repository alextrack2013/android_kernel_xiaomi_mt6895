...
#ifdef __XIAOMI_CAMERA__
enum SENSOR_PATTERN_MODE_ENUM {
	SENSOR_TEST_PATTERN_MODE_OFF = 0,// v3.2
	SENSOR_TEST_PATTERN_MODE_SOLID_COLOR,// v3.2
	SENSOR_TEST_PATTERN_MODE_COLOR_BARS,// v3.2
	SENSOR_TEST_PATTERN_MODE_COLOR_BARS_FADE_TO_GRAY,// v3.2
	SENSOR_TEST_PATTERN_MODE_PN9,// v3.2
	SENSOR_TEST_PATTERN_MODE_BLACK,// v3.6
	SENSOR_TEST_PATTERN_MODE_CUSTOM1 = 256,// v3.2
};
#endif
